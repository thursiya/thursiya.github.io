...
const goods = [																			// M, A | I, N, T | W, S, C, H, X | P, F
	...
	{ name: "Radioactive Waste", type: "assorted", file: "radioactives", price: 500, stat: "dangerous", supply: "*", demand: "-", tag: "Someone else's problem, until it isn't.<br><i>Produced by industrial processes and some damaged goods. Must pay to have them disposed of.</i>", desc: "Spent reactor fuel and fission byproducts. Legally restricted, illegally dumped, occasionally weaponized. Handling requires specialized containment and a disregard for self-preservation." },				//80) I, HT -> !
	{ name: "Regolith", type: "aggregate", file: "regolith", price: 300, supply: "Mi T", demand: "Ag Ocean", tag: "Ground beneath your dreams — and your domes.", desc: "Regolith is the pulverized bedrock of a thousand worlds — harvested, sieved, and compacted into the foundation for colonies, farms, and megastructures. Terraformers blend it with organics to birth soil; oceanic engineers pump it into the deep to anchor arcologies. It’s the dust that civilization stands on, traded by the megaton across the void." },
	{ id: "robo1", name: "Robots", grade: 1, type: "Cyberops", file: "robots", price: 4000, stat: "dangerous", supply: "H Ma", demand: "Ag F I Mi T", tag: "Workers who never ask for pay.<br><i>Illegal on theocratic worlds.</i>", desc: "Autonomous mechanical units for industrial, domestic, or security purposes. Range from cheap utility drones to high-end adaptive AIs. Banned on theocracies due to moral prohibitions on synthetic life." },	//81) HT -> M, Ag, I, T, Af
	{ id: "robo2", name: "Robots", grade: 2, type: "Microtronic", file: "robots", price: 6000, stat: "dangerous", supply: "H", demand: "Af Ag I Ma Mi T (F)" },
	{ id: "robo3", name: "Robots", grade: 3, type: "Nanoworks", file: "robots", price: 8000, stat: "dangerous", supply: "H", demand: "Af C Ma" },
	{ id: "robo4", name: "Robots", grade: 4, type: "Mitsutomo", file: "robots", price: 10000, stat: "dangerous", supply: "H", demand: "Af (C)" },
