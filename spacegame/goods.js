	...
	{ name: "Chemicals", type: "assorted", file: "chemicals", price: 500, stat: "sensitive", supply: "Mi T F", demand: "H I P S (X)", tag: "Every colony runs on something volatile.", desc: "Industrial reagents, solvents, and compounds for refining, manufacturing, or scientific use. Dangerous in bulk, indispensable everywhere. Some double as illicit precursors in the right hands." },
	...
	{ name: "Radioactive Waste", type: "assorted", file: "radioactives", price: 500, stat: "dangerous", produce: "*", demand: "-", tag: "Someone else's problem, until it isn't.<br><i>Produced by industrial processes and some damaged goods. Must pay to have them disposed of.</i>", desc: "Spent reactor fuel and fission byproducts. Legally restricted, illegally dumped, occasionally weaponized. Handling requires specialized containment and a disregard for self-preservation." },				//80) I, HT -> !
	...
	{ name: "Waste Products", type: "assorted", file: "waste-products", price: 50, produce: "*", demand: "-", tag: "Everything has an afterlife.<br><i>Produced by industrial processes, large populations, and damaged goods. Must pay to have them disposed of.</i>", desc: "Industrial runoff, biological residue, and other byproducts of production. Officially recycled, unofficially exported. Some colonies make fortunes cleaning up what others discard." },		//93) Af, C, Mx, HT -> *
