const goods = [																			// M, Ag | I, T | Af, S, C, HT, Mx | P, F
	...
	{ name: "Animal Meat", grade: 2, type: "Terran", file: "animal-meat", price: 2500, stat: 'cold', supply: { A: 1.2, C: -1, F: 1.2, H: -2, I: -1, M: -1, N: -1, T: -1, W: -2 }, produce: "Ag F", demand: "Af C H I Ma Mi T" },				// Ag -> Af2,		(!)
	{ name: "Animal Meat", grade: 3, type: "Lacotian", file: "animal-meat", price: 4500, stat: 'cold', supply: { A: 1.3, C: -1, F: 1.3, H: -2, N: -1, W: -3 }, produce: "Ag F", demand: "Af C H Ma (T)" },				// Ag -> Af3, 		(!)
	...
	{ name: "Animal Skins", grade: 2, type: "Terran", file: "animal-skins", price: 7500, supply: { A: 1.2, C: -1, F: 1.2, W: -3 }, produce: "Ag F", demand: "Af C" },	// Ag -> Af3	!
	{ name: "Animal Skins", grade: 3, type: "Lacotian", file: "animal-skins", price: 12500, supply: { A: 1.3, C: -1, F: 1.3, W: -3 }, produce: "Ag F", demand: "Af C" },							// Ag -> Af3	!
	...
	{ name: "Automobiles", grade: 2, type: "Geotech", file: "automobiles", price: 4000, stat: 'sensitive', supply: { A: -1, C: -1, F: -1, H: -1, I: -1, M: -1, N: 1 }, produce: "Ma", demand: "Ag C F H Mi I (S)" },			// I -> Af1, S1, C3, *1
	{ name: "Automobiles", grade: 2, type: "5-Star", file: "automobiles", price: 4000, stat: 'sensitive', supply: { A: -1, C: -1, F: -1, H: -1, I: -1, M: -1, N: 1 }, produce: "Ma", demand: "Ag C F H Mi I (S)" },			// I -> Af1, S1, C3, *1
	{ name: "Automobiles", grade: 3, type: "Mechanica", file: "automobiles", price: 5500, stat: 'sensitive', supply: { C: -1, H: -2, N: 1, W: -2 }, produce: "Ma", demand: "Af C H" },		// I -> Af2, C2
	{ name: "Automobiles", grade: 4, type: "Eunion", file: "automobiles", price: 8000, stat: 'sensitive', supply: { H: -1, N: 1, W: -3 }, produce: "Ma", demand: "Af H (C)" },			// I -> Af3, C1
	{ name: "Bacterial Farms", grade: 1, type: "AmritJivan", file: "bacterial-farms", price: 3000, stat: 'dangerous', supply: { H: -2, I: 1, Mil: -1, T: -1 }, produce: "I", demand: "Military H T", tag: "Feed worlds. End worlds. Same technology.<br><i>Military worlds will demand them.<br>Illegal on democratic worlds.</i>", desc: "Self-contained bioreactors cultivating microbial cultures that convert biomass into food, fuel, or pharmaceuticals. But their real value lies in weaponized biology: programmable strains designed for sterilization, siege, or ecosystem collapse. Bacterial farms are the backbone of the interstellar bioweapons trade—regulated in name only, and a strategic necessity for every militarized world. Officially banned on democratic planets, unofficially indispensable to the economies that defend them." },	//13) HT? -> HT, Military	!		? stat: 'live' ?
	{ name: "Bacterial Farms", grade: 2, type: "Astromedica", file: "bacterial-farms", price: 5000, stat: 'dangerous', supply: { H: -2, I: 1, Mil: -1, T: -1 }, produce: "I", demand: "Military H T" },// -> HT	!
	{ name: "Bacterial Farms", grade: 3, type: "Aegis", file: "bacterial-farms", price: 7000, stat: 'dangerous', supply: { H: -2, I: 1, Mil: -2 }, produce: "I", demand: "Military H" },	// -> HT	!
	...
	{ name: "Consumer Goods", grade: 2, type: "Nanoworks", file: "consumer-goods", price: 2000, supply: { H: 1, I: -1, M: -1, N: -1, P: 1, T: -1, W: 0 }, produce: "H P (Af)", demand: "C F I Ma Mi S T" },						// -> *1
...
function worldGoods(w) {
	...
	// Democ: if med1: +med1 med2, if rob2: +rob1 rob2
	...
	// Democ: if med1: +med1 med2, if air2: +air2, if cons1,2: +cons3 cons4, if farm2: +farm3, if hydr: +hydr3, if meat1,2: +meat3, if peri: +peri3, if prob: +prob2 || if air1: +air1, +bact1 bact2, if peri1: +peri1, +exp1 exp1 exp2, if farm2: +farm1, if hydr: +hydr1, if peri: +peri1 peri2 peri2b, if prob: +prob1, +slav3 slav4
