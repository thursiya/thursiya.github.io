...
function localeFlavour (site, location = here) {
	...
	out += rnd([...({
		bar: ["#.name# is known for a #seedy|down and out|questionable# clientele. Outside the sizeable #poorGroupN# population can attest to this fact.",
			"#.name# is one of the better bars around and it's not uncommon to find #personN.s# #activityV.ing# after work here."],
		cafe: ["This diner serves up the best #foodNP# on #.here# - or at least that's what they claim."],
		embassy: ["#personAdj[!seedy].caps# foreign dignitaries are the main clientele here."],
		factory: ["Surely it's one of many factories on #.here# #producing|churning out|making# #consumer|industrial|farming|corporate# #goods|equipment|items#."],
		hotel: ["This is hardly the hotel it used to be. It seems to cater more to #poorGroupN.s# than its original clientele."],
		house: ["It's just a conventional home inside, nothing special."],
