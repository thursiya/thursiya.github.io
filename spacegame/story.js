...
const storyFramework = {
	...
	corpNamePre: ["aero", "afro", "agri", "alpha", "amerI", "apex", "arabI", "arma", "astro", "auto", "beta", "bio", "brain", "cryo", "crypto", "cyber", "data", "delta", "digi", "electro", "enviro", "equi", "euro", "fibre", "futurE", "galacti", "gamma", "genE", "hydro", "indo", "infini", "info", "intelli", "inter", "mecha", "medi", "mega", "lunar", "meso", "mili", "neo", "neuro", "nexA", "nova", "octo", "omega", "omni", "orbito", "planet", "posi", "prima", "proto", "psi", "quantum", "radial", "sino", "sky", "socio", "solA", "space", "star", "sub", "super", "symbio", "tele", "terra", "thermA", "titan", "trans", "uni", "verI", "vita", "x-", "zeta"],
