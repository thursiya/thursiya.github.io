...
const storyFramework = {
	...
	lightAdj: ["bright", "dull", "vivid", "pale", "dark", "deep"],
	...
	authors: ["Adams", "Asimov", "Banks", "Bradbury", "Bujold", "Burroughs", "Butler", "Card", "Clarke", "Deckard", "Ellison", "Gibson", "Heinlein", "Herbert", "Huxley", "Le Guin", "Lem", "Lucas", "Niven", "Orwell", "Roddenberry", "Silverberg", "Stephenson", "Sterling", "Verne", "Vinge", "Wells"],
	celebrity: ["#{data_celeb: rnd(PersonName)}.data_celeb#, #the famous|a local# #celebrityOccupation#"],
	celebrityOccupation: ["rockstar", "actor", "politician", "netstar", "racer", "socialite", "athlete", "comedian", "game designer", "captain", "general", "dancer", "courtesan", "prophet"],	
	...
	nameLast: ["Achebe", "Adebayo", "Afolabi", "Ahmed", "Akintola", "Ali", "Anderson", "Aquino", "Azikiwe", "Bai", "Balogun", "Bauer", "Bautista", "Beridze", "Bernard", "Bouchard", "Boyko", "Brown", "Buhari", "Cai", "Calderon", "Campbell", "Chatterjee", "Chen", "Choi", "Chowdhury", "Chukwu", "Clark", "Cohen", "Danjuma", "Das", "Davis", "dela Cruz", "Demir", "De Vries", "Diaz", "Dimitrov{fem: 'Dimitrova'}", "Dubois", "Esposito", "Evans", "Ferrari", "Fischer", "Gagnon", "Gao", "Garcia", "Gazi", "Gill", "Gonzalez", "Gruber", "Hansen", "Harris", "Hayashi", "Hernandez", "Horvat", "Hossain", "Hoxha", "Huang", "Ito", "Ivanov{fem: 'Ivanova'}", "Jackson", "Jeong", "Johansson", "Johnson", "Jones", "Kaczmarek", "Kang", "Kaya", "Kelly", "Khan", "Kim", "Kobayashi", "Korhonen", "Kowalski{fem: 'Kowalska'}", "Kumar", "Kwon", "Lal", "Lam", "Laurent", "Lee", "Levi", "Lin", "Liu", "Lopez", "Ma", "MacDonald", "Mammadov{fem: 'Mammadova'}", "Mandal", "Martin", "Martinez", "Mazur", "Melnyk", "Meyer", "Miller", "Mirza", "Mitra", "Mizrahi", "Monge", "Moore", "Mora", "Morales", "Moreau", "Morgan", "Murphy", "Murray", "Muto", "Nakamura", "Nagy", "Nielsen", "Novak", "Nguyen", "Obasanjo", "Oh", "Okafor", "Olsen", "Oyenusi", "Papadopoulos", "Park", "Patel", "Perez", "Petrov{fem: 'Petrova'}", "Radu", "Ram", "Ray", "Robinson", "Rodriguez", "Rossi", "Roy", "Sadza", "Santos", "Sato", "Schneider", "Seo", "Sharma", "Silva", "Singh", "Smirnov{fem: 'Smirnova'}", "Smith", "Sokolov{fem: 'Sokolova'}", "Solarin", "Song", "Sousa", "Stewart", "Sullivan", "Suzuki", "Takahashi", "Taiwo", "Tamm", "Tan", "Tanaka", "Thakur", "Thomas", "Thompson", "Tran", "Traore", "Tremblay", "Van Dyk", "Villaneuva", "Vlahos", "Wagner", "Walker", "Wang", "Watanabe", "White", "Williams", "Wilson", "Wojcik", "Wright", "Wu", "Yadav", "Yamada", "Yamamoto", "Yang", "Yee", "Yilmaz", "Yoon", "Zhang", "Zhao", "Zhou"],
	...
	corpMottoPre: ["Adaptability", "Connection", "Excellence", "Experience", "Forward-Thinking", "Improvement", "Innovation", "Leadership", "Precision", "Reliability", "Responsibility", "Sustainability", "Synergy", "Teamwork", "Value", "Vision"],
	corpMottoPost: ["and Performance", "Focused", "for a Better Tomorrow", "for the Future", "Going Further", "in Action", "in Every Detail", "is Our Priority", "Leads to Success", "Makes a Difference", "Matters", "You Can Trust"],
	corpNamePre: ["aero", "afro", "agri", "alpha", "amerI", "apex", "arabI", "arma", "astro", "auto", "beta", "bio", "brain", "cryo", "crypto", "cyber", "data", "delta", "digi", "electro", "enviro", "equi", "euro", "fibre", "futurE", "galacti", "gamma", "genE", "global", "hydro", "indo", "infini", "info", "intelli", "inter", "mecha", "medi", "mega", "lunar", "meso", "mili", "neo", "neuro", "nexA", "nova", "octo", "omega", "omni", "orbito", "planet", "posi", "prima", "proto", "psi", "quantum", "radial", "sino", "sky", "socio", "solA", "space", "star", "sub", "super", "symbio", "tele", "terra", "thermA", "titan", "trans", "uni", "verI", "vita", "x-", "zeta"],
	corpNamePost: ["access", "active", "atomica", "base", "biz", "brand", "byte", "capital", "chem", "co", "comm", "corps", "craft", "credit", "dev", "dock", "droid", "dynamics", "dyne", "fact", "field", "forge", "form", "fusion", "goods", "grav", "guard", "innovations", "labs", "life", "link", "lock", "logic", "lux", "matics", "matrix", "mind", "motion", "nautica", "nav", "net", "nomics", "optics", "pharm", "port", "power", "scan", "search", "sector", "sense", "soft", "store", "storm", "sys", "tech", "tronic", "trust", "verse", "vision", "ware", "wave", "works"],
	...
	locV: ["rest", "sit×{ed: 'sat'}", "stand{ed: 'stood'}", "lie{ed: 'lay ', ing: 'lying', s: 'is lying'}", "wait", "linger<anim><rare>"],
...
function localeFlavour (site, location = here) {
	...
	out += rnd([...({
		...
		house: ["It's #just|# a #conventional|normal|simple# home #inside|#, nothing #special|unique|out of the oridinary# #about it|#."],
