...
const storyFramework = {
	...
	corpNamePre: ["aero", "afro", "agri", "alpha", "amerI", "apex", "arabI", "arma", "astro", "beta", "bio", "cryo", "crypto", "cyber", "data", "digi", "electro", "enviro", "equi", "euro", "futurE", "galacti", "gamma", "genE", "hydro", "indo", "infini", "info", "intelli", "inter", "mecha", "medi", "mega", "lunar", "meso", "mili", "neo", "neuro", "nexA", "nova", "octo", "omega", "omni", "orbito", "planet", "posi", "prima", "proto", "psi", "quantum", "radial", "sino", "sky", "socio", "solA", "space", "star", "sub", "super", "symbio", "tele", "terra", "titan", "uni", "verI", "vita", "x-", "zeta"],
	corpNamePost: ["access", "active", "atomica", "base", "biz", "brand", "byte", "capital", "chem", "co", "corps", "craft", "credit", "dev", "dock", "droid", "dynamics", "dyne", "fact", "forge", "form", "fusion", "goods", "grav", "guard", "innovations", "labs", "life", "link", "lock", "logic", "lux", "matics", "matrix", "mind", "motion", "nautica", "net", "nomics", "optics", "pharm", "port", "power", "search", "sense", "soft", "store", "storm", "sys", "tech", "tronic", "trust", "vision", "ware", "works"],
