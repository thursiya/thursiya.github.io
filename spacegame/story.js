...
const storyFramework = {
	...
	corpNamePre: ["aero", "afro", "agri", "alpha", "amerI", "apex", "arabI", "arma", "astro", "beta", "bio", "cryo", "crypto", "cyber", "data", "digi", "electro", "enviro", "equi", "euro", "futurE", "galacti", "gamma", "genE", "hydro", "indo", "infini", "info", "intelli", "inter", "mecha", "medi", "mega", "lunar", "meso", "mili", "neo", "neuro", "nexA", "nova", "octo", "omega", "orbito", "planet", "posi", "prima", "proto", "psi", "quantum", "radial", "sino", "sky", "socio", "solA", "space", "star", "sub", "super", "symbio", "tele", "terra", "titan", "uni", "verI", "vita", "x-", "zeta"],
