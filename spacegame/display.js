...
function displayInfo(type, which) {
	...
	if (type == "economy") {
		...
		const e = ({"Affluent": [["Perishable Goods", "Consumer Goods", "Liquor", "Luxury Goods", "Robots"], `Affluent worlds are polished, cosmopolitan places where comfort is treated as a civic virtue. Tower cities shimmer with holographic signage, transit tubes hum with silent magnetics, and the wealthy drift between curated experiences and privatized paradise domes. Their prosperity is conspicuous—and their appetite for imports is endless.</p><p>Affluent worlds do not normally produce goods of their own, except corporate variants that manufacture branded perishable goods, consumer goods, liquor, luxury goods, and robots.</p><p>They demand vast quantities of high-end vehicles, medicines, robots, animal meat, liquor, luxury goods, gene stock, consumer goods, government artifacts, and fruit & vegetables. They also require gemstones, grain, deuterium cells, lumber, top-grade hydroponic farms, perishable goods, and all types of live animals. Democratic worlds insist on superior quality goods, while other governments tolerate or quietly seek upper-end hand weapons, narcotics, and child, bonded, and Luxorian slaves.`],
			"Agricultural": [["Fruit & Vegetables", "Grain", "Live Animals", "Animal Meat", "Animal Skins", "Liquor", "Gene Stock", "Narcotics", "Consumer Goods", "Hydroponic Farms"], `Agricultural worlds are vast, open expanses—endless fields, domed orchards, gene-ranching complexes, and atmosphere-treated paddies stretching to the horizon. Life is slower here but never simple; harvest cycles, animal husbandry, and genetic curation shape the rhythm of daily life.</p><p>Agricultural planets supply fruit & vegetables, grain, and live animals, meat, and skins—either bio-engineered, Terran, or Lacotian. They also produce gene stock, hydroponic farms, liquor, cheap perishable goods, minor narcotics, and a trickle of consumer goods. Corporate variants produce larger volumes of narcotics and branded goods.</p><p>Demand is focused on low-grade automobiles and robots, lumber, cheap medicine, volatiles, and lots of fertilizer, farming equipment, atmospheric catalysts, and regolith. Democratic planets additionally seek higher-quality robots and medicine, while others often buy adult forced labour. Agricultural worlds also import live animals not native to their local ecosystems.`],
			"Cultural": [["Liquor", "Luxury Goods", "Perishable Goods", "Consumer Goods"], `Cultural worlds pulse with art, festivals, performance halls, and iconography. Streets overflow with off-world visitors seeking curated experiences, local aesthetics, and holotheatre traditions found nowhere else. Tourism is a resource here, as real as ore veins or hydroponic stacks.</p><p>Cultural planets produce expensive liquor and luxury goods, along with cheap perishable and consumer goods. Corporate variants export larger volumes of their branded goods.</p><p>Cultural worlds attract more visitors than other worlds. They demand a wide variety of vehicles, animal meats and skins, exotic live animals, gene stock, robots, consumer and perishable goods, fruit & vegetables, grain, luxury goods, lumber, precious metals, minor narcotics, and all grades of medicine. Democratic worlds demand higher quality, while others consume a broader range of narcotics and may also purchase regular and Luxorian slaves.`],
			"Frontier": [["Liquor", "Precious Metals", "Slaves", "Live Animals", "Animal Meat", "Animal Skins", "Chemicals", "Grain", "Petroleum", "Narcotics", "Consumer Goods", "Perishable Goods"], `Frontier worlds are rugged, sprawling settlements at the edge of mapped space—half built, half abandoned, always shifting. Life is hard; communities survive through grit, barter, and whatever industry can be wrestled from raw terrain.</p><p>They produce small amounts of cheap liquor, precious metals, slaves, and live animals, meat, and skins. They also output chemicals, grain, petroleum, narcotics, and cheap consumer or perishable goods. Corporate worlds export larger volumes of branded goods.</p><p>The frontier demands fertilizer, fruit & vegetables, synthetic meat, water, atmospheric catalysts, regolith, deuterium cells, low-end automobiles, and basic medicine, probes, and robots. These worlds also import mid-grade consumer and perishable goods, narcotics, and liquor of slightly better quality than their own. Democratic worlds seek better-quality goods, while others pay for industrial explosives, low- to mid-grade hand weapons, and hallucinogenic narcotics.`],
			"High Tech": [["Atmospheric Catalysts", "Electronics", "Gene Stock", "Medicine", "Robots", "Probes", "Slaves", "Synthetic Meat", "Consumer Goods", "Narcotics", "Luxury Goods", "Water"], `High Tech worlds are gleaming hyper-urban cores defined by neon skylines, orbital foundries, and server-spires humming with data. Innovation is their lifeblood, and their populations live surrounded by automation, biotech, and omnipresent networks.</p><p>They produce electronics, medicines, robots, probes, gene stock, bio-engineered slaves, synthetic meat, low-grade consumer goods, moderate and high-grade narcotics, high-grade luxury goods, atmospheric catalysts, and—on ocean worlds—water. Corporate governance increases branded production.</p><p>High Tech worlds demand all types of vehicles, perishable goods, liquor, animal meats, high-grade consumer goods, low-grade luxury goods, fruit & vegetables, grain, and hydroponic farms. Their chip and device factories require chemicals, industrial goods, volatiles, and large quantities of precious metals. Democratic worlds demand higher quality, while other governments may make use of bacterial farms and occasionally purchase bonded or Luxorian slaves.`],
			"Industrial": [["Atmospheric Catalysts", "Industrial Equipment", "Bacterial Farms", "Explosives", "Fertilizer", "Heavy Plastics", "Liquid Oxygen", "Deuterium Cells"], `Industrial worlds are iron-grey skylines, thundering foundries, vapour plumes, and ceaseless machinery. They exist to manufacture on a scale that reshapes landscapes and exports the results to the entire sector.</p><p>These planets produce industrial equipment, bacterial farms, explosives, fertilizer, heavy plastics, liquid oxygen, atmospheric catalysts, and deuterium cells. Corporate variants produce additional branded goods.</p><p>Industrial economies require cheap electronics, low-grade robots, adult slaves (except Luxorian), and large volumes of chemicals, minerals, petroleum, volatiles, and other feedstocks to sustain their factories. Populations rely on synthetic meat, low-grade vehicles, consumer goods, medicine, narcotics, liquor, animal meat, and large quantities of low-grade perishables.`],
			"Manufacturing": [["Automobiles", "Air Processors", "Farming Equipment", "Hand Weapons", "Industrial Goods", "Luxury Goods", "Robots"], `Manufacturing worlds are dominated by megafactories, automated assembly complexes, and sprawling logistics yards. Efficiency is a cultural value, and production cycles run continuously under artificial daylight.</p><p>They manufacture automobiles, air processors, farming equipment, hand weapons, industrial goods, luxury goods, and basic manufacturing robots. Corporate variants produce larger quantities of branded products.</p><p>These planets demand all types of animal and synthetic meat, liquor, low-grade consumer goods, medicine, narcotics, and large volumes of perishable goods. Their factories require grain, fruit & vegetables, gemstones, precious metals, liquid oxygen, uneducated or bonded slaves, industrial equipment of all types, and many mid-grade robots.`],
			"Mining": [["Chemicals", "Gemstones", "Minerals", "Petroleum", "Precious Metals", "Regolith", "Volatiles", "Lumber", "Water"], `Mining worlds are harsh extraction economies—strip-quarries, drilling fields, regolith scoops, volatile harvesters, and underground settlements carved directly into the planet's crust. Everything revolves around pulling raw resources from unforgiving environments. Life is harsh, transient, and transactional, and most residents measure time in shifts rather than seasons.</p><p>They produce chemicals, gemstones, minerals, petroleum, precious metals, regolith, volatiles, and—depending on terrain—forestry products and water.</p><p>Mining infrastructure demands air processors, probes, adult forced labourers (especially bio-engineered), low-grade vehicles, robots, industrial equipment, and industrial explosives. Populations consume cheap perishable goods, synthetic meat, and some low-grade animal meat. They also require low-grade atmospheric catalysts, consumer goods, narcotics, and large volumes of cheap liquor.`],
			"Mixed": [["Consumer Goods", "Lumber", "Water"], `Mixed-economy worlds are unpredictable places—patchworks of settlements, climates, and industries coexisting with only loose coordination. Their diversity allows resilience, but also produces chaos in trade patterns.</p><p>A mixed economy's local market acts as an efficient vacuum, consuming nearly all standard, mass-produced commodities. They produce limited amounts of consumer goods, forestry products, or water depending on geography, as well as a random assortment of excess goods. Their demands vary widely, often including chemicals, plastics, or lumber, or simply larger volumes of consumer goods when production is low.`],
			"Prison": [["Consumer Goods", "Minerals", "Slaves", "Lumber", "Water"], `Prison worlds are bleak, tightly controlled environments dominated by labour compounds, surveillance grids, and settlement blocks built with austere efficiency. Almost every aspect of life is shaped by containment and forced industry.</p><p>They produce low-grade consumer goods, minerals, adult (especially uneducated) forced labourers, forestry products, and—on ocean or ice worlds—water. Corporate holdings generate additional branded goods.</p><p>Prison economies buy cheap vehicles, chemicals, heavy plastics, lumber (if not locally abundant), and all types of electronics. Populations subsist on grain, cheap perishable goods, and large quantities of synthetic meat.`],
			"Slum": [["Consumer Goods", "Perishable Goods", "Luxury Goods", "Slaves", "Lumber"], `Slum worlds are dense, chaotic, and vibrant in dangerous ways—stacked tenements, black-market bazaars, and informal economies that spill through neon-lit corridors. Wealth exists here, but rarely legally.</p><p>They produce high-grade consumer goods, moderate- to high-grade perishables, all types of luxury goods, and slaves of every category (especially children and uneducated, with rare Luxorians). Forestry output exists on desert or rocky worlds. Corporate control adds branded goods.</p><p>Slum worlds demand cheap vehicles and perishables, chemicals, gemstones, lumber (especially on ocean worlds), heavy plastics, deuterium cells, grain, low-grade consumer goods, synthetic meat, electronics, and large quantities of low-quality liquor. Democratic worlds demand slightly better goods, while other governments buy explosives and large numbers of hand weapons and high-grade narcotics where legal.`],
			"Terraforming": [["Chemicals", "Minerals", "Regolith", "Volatiles"], `Terraforming worlds are works-in-progress: half-formed biospheres, atmospheric machines humming across barren plains, and settlement domes perched against hostile climates. Their economies exist to reshape entire planets into habitable environments.</p><p>As a necessary byproduct of planet-scale engineering, they produce a surplus of chemicals, minerals, regolith, and volatiles.</p><p>Terraforming worlds demand air processors, farming equipment, gene stock, fruit & vegetables, hydroponic farms, probes, liquid oxygen, all types of live animals, low-grade robots, and large quantities of water, fertilizer, and atmospheric catalysts. Populations require low-grade consumer goods, perishable goods, animal and synthetic meat, and cheap medicine. Democratic worlds seek slightly higher quality goods, while others may purchase bacterial farms, explosives, and bonded or bio-engineered slaves.`]})[which];

/*
		const e = ({"Affluent": [["Perishable Goods", "Consumer Goods", "Liquor", "Luxury Goods", "Robots"], `Affluent worlds do not normally produce goods unless they are a corporate world, in which case they will produce their own branded perishable goods, consumer goods, liquor, luxury goods, and robots.</p><p>They demand a lot. Affluent society requires lots of high-end vehicles, medicine, robots, animal meat, liquor, luxury goods, consumer goods, government artifacts, and fruit & vegetables. They also need gemstones, grain, hydrogen fuel cells, lumber, top-grade hydroponic farms and perishable goods, and all types of live animals. Democratic worlds will demand better quality goods, while others will pay for upper-end hand weapons and narcotics, large quantities of animal skins, and child, regular, and especially Luxorian slaves.`],
			"Agricultural": [["Fruit & Vegetables", "Grain", "Live Animals", "Animal Meat", "Animal Skins", "Liquor", "Gene Stock", "Narcotics", "Consumer Goods", "Hydroponic Farms"], `Agricultural planets supply variable amounts of fruit & vegetables, grain, and either bio-engineered, Terran, or Lacotian live animals, meat, and skins. They also produce some minor narcotics and cheap perishable goods. Agricultural worlds will produce hydroponic farms and liquor (high-grade on democratic worlds, and low-grade on others). Corporate worlds will produce more minor narcotics and more of their own branded goods. Expect small-scale forestry on rocky planets and more hydroponic farms on ocean worlds.</p><p>Demand is for low-grade automobiles and robots, fertilizer, lumber, cheap medicine, and lots of farming equipment. Democratic planets will demand better medicine and robots, while others demand adult forced labour. Agricultural worlds will also buy live animals that are not produced there.`],
			"Cultural": [["Liquor", "Luxury Goods", "Perishable Goods", "Consumer Goods"], `Cultural worlds are more likely to attract visitors.</p><p>They produce expensive liquor and luxury goods, and cheap perishable and consumer goods on non-democratic planets. Corporate worlds will produce more of their own branded goods.</p><p>The people of cultural worlds demand a variety of vehicles, animal meat and skins, fancier live animals, upper-end robots, consumer and perishable goods, fruit & vegetables, grain, precious metals, lumber, luxury goods, minor narcotics, and all grades of medicine. Democratic worlds will demand better quality goods, while others will pay for a range of narcotics as well as regular and Luxorian slaves.`],
			"Frontier": [["Liquor", "Precious Metals", "Slaves", "Live Animals", "Animal Meat", "Animal Skins", "Chemicals", "Grain", "Petroleum", "Narcotics", "Consumer Goods", "Perishable Goods"], `Frontier worlds produce small amounts of cheap liquor, precious metals, slaves, and either bio-engineered, Terran, or Lacotian live animals, meat, and skins. They may produce a small amount of chemicals, grain, petroleum, minor narcotics, or cheap consumer or perishable goods. Corporate worlds will produce more of their own branded goods.</p><p>The frontier needs fertilizer, fruit & vegetables, synthetic meat, water, low-end automobiles, and basic medicine, probes, and robots. These worlds also demand mid-grade consumer and perishable goods, narcotics and liquor (just better than what would be produced there). Democratic worlds will demand better quality goods and cheap electronics, while others will pay for industrial explosives, low to mid-grade hand weapons, and cheap perishable goods.`],
			"High Tech": [["Atmospheric Catalysts", "Electronics", "Gene Stock", "Medicine", "Robots", "Probes", "Slaves", "Synthetic Meat", "Consumer Goods", "Narcotics", "Luxury Goods", "Water"], `High Tech worlds produce all types of electronics, medicines, robots, and probes, plus bio-engineered slaves, synthetic meat, low-grade consumer goods, moderate and high-grade narcotics, and high-grade luxury goods. Ocean worlds will also sell some water. Corporate worlds will produce more of their own branded goods.</p><p>Being on the cutting edge of technology creates a populous yearning for all types of vehicles, perishable goods, liquors and animal meats, high-grade consumer goods, low-grade luxury goods, fruit & vegetables, grain, and hydroponic farms. High tech chip factories need chemicals, industrial goods, and lots of precious metals. Democratic worlds will demand better quality goods, while others are able to use bacteria farms and even a few regular or Luxorian slaves.`],
			"Industrial": [["Atmospheric Catalysts", "Industrial Equipment", "Bacterial Farms", "Explosives", "Fertilizer", "Heavy Plastics", "Liquid Oxygen", "Deuterium Cells"], `Industrial worlds produce all types of industrial equipment, bacteria farms, and explosives, plus fertilizer, heavy plastics, liquid oxygen, and hydrogen fuel cells. Corporate worlds will produce more of their own branded goods.</p><p>Industrial planets need cheap electronics, low-grade robots, all non-Luxorian slaves, and lots of chemicals, iron ore, minerals, and petroleum to supply their industries. The population demand synthetic meat, low-grade vehicles, consumer goods, medicine, narcotics, liquor, and animal meat, as well as lots of low-grade perishable goods.`],
			"Manufacturing": [["Automobiles", "Air Processors", "Farming Equipment", "Hand Weapons", "Industrial Goods", "Luxury Goods", "Robots"], `Manufacturing worlds produce all types of automobiles, air processors, farming equipment, hand weapons, industrial and luxury goods. They also make basic manufacturing robots. Corporate worlds will produce more of their own branded goods.</p><p>Manufacturing planets will demand all types of animal and synthetic meat, liquor, low-grade consumer goods, medicine, narcotics, and lots of perishable goods. Their factories will need a regular supply of grain, fruit & vegetables, gemstones, precious metals, liquid oxygen, uneducated or regular slaves, all types of industrial equipment, and lots of low to mid-grade robots.`],
			"Mining": [["Chemicals", "Gemstones", "Minerals", "Petroleum", "Precious Metals", "Regolith", "Volatiles", "Lumber", "Water"], `Mining worlds produce variable amounts of chemicals, gemstones, iron ore, minerals, petroleum, and precious metals. Expect forestry on desert and especially rocky planets and water extraction on ice worlds.</p><p>Mining infrastructure demands air processors, probes, adult forced labourers (especially bio-engineered), low-grade automobiles, robots, and lots of industrial equipment and industrial explosives. The populous eats mostly cheap perishable goods and some synthetic and cheap animal meat. They need a regular supply of low-grade consumer goods, narcotics, and lots of cheap liquor.`],
			"Mixed": [["Consumer Goods", "Lumber", "Water"], `Mixed economies could produce and demand anything. They will either demand a variety of consumer goods or produce some consumer goods and demand chemicals, plastics, or lumber. Expect forestry on desert and especially rocky planets and some water sold on ocean worlds.`],
			"Prison": [["Consumer Goods", "Minerals", "Slaves", "Lumber", "Water"], `Prison worlds produce low-grade consumer goods, iron ore, minerals, and large numbers of forced labourers (especially uneducated and bio-engineered). Expect forestry on desert and especially rocky planets and water extraction on ocean and especially ice worlds. Corporate worlds will produce more of their own branded goods.</p><p>The prison economy buys cheap vehicles, chemicals, heavy plastics, lumber (if not in ready supply), and all types of electronics. The populous subsist off of grain, cheap perishable goods, and lots of synthetic meat.`],
			"Slum": [["Consumer Goods", "Perishable Goods", "Luxury Goods", "Slaves", "Lumber"], `Slum economies produce high-grade consumer goods, moderate to high-grade perishable goods and all types of luxury goods. They will sell all types of slaves, especially children and uneducated, and even a rare Luxorian. Expect forestry on desert and especially rocky planets. Corporate worlds will produce more of their own branded goods.</p><p>Slum worlds demand cheap vehicles and perishable goods, chemicals, gemstones, lumber (on ocean or ice planets), heavy plastics, hydrogen fuel cells, grain, low-grade consumer goods, synthetic meat, all types of electronics, and lots of low quality liquor. Democratic worlds will demand slightly better quality goods, while others buy explosives and lots of hand weapons and narcotics (especially high-grade) where legal.`],
			"Terraforming": [["Chemicals", "Minerals", "Regolith", "Volatiles"], `Terraforming worlds produce variable amounts of chemicals, iron ore, and minerals.</p><p>These planets demand air processors, farming equipment, fruit & vegetables, hydroponic farms, probes, liquid oxygen, all types of live animals, low-grade robots, and lots of fertilizer and water. The people need low-grade consumer goods, perishable goods, animal and synthetic meat, and cheap medicine. Democratic worlds will demand some better quality goods, while other worlds will buy bacteria farms, explosives, and regular or bio-engineered slaves.`]})[which];
*/
		out = `<div style="display: flex; gap: 10px; align-items: center"><span class="big"><b>${which}&nbsp;</b></span>${e[0].reduce((t, v) => `${t}<img src="images/goods/${goods.find(a => a.name == v).file}.png" draggable="false"> `, "")}</div><p>${e[1]}</p>`;
	}
	if (type == "good") {
