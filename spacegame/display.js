...
function displayInfo(type, which) {
	...
	if (type == "economy") {
		...
		out = `<div style="display: flex; gap: 10px; align-items: center"><img src="images/foci/${which}.png" draggable="false" style="vertical-align: middle"> <span class="big"><b>${which}&nbsp;</b></span>${e[0].reduce((t, v) => `${t}<img src="images/goods/${goods.find(a => a.name == v).file}.png" draggable="false"> `, "")}</div><p>${e[1]}</p>`;
	}
